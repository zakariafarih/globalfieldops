...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleValidation(
        ...
        ex.getBindingResult().getFieldErrors().forEach(fe -> fieldErrors.merge(
                fe.getField(),
    ...
    public ResponseEntity<ApiError> handleServiceCommunication(
            ServiceCommunicationException ex,
            HttpServletRequest request) {

        log.error("Downstream service failure on {}: {}", request.getRequestURI(), ex.getMessage());
